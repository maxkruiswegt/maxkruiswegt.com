...
description: 'Een webapplicatie om projecten te plannen.'
images:
  - /images/projectplanner/Banner.webp
  - /images/projectplanner/Banner2.webp
  - /images/projectplanner/Banner3.webp
---
...
- 🆕 **Maak een Account aan**: Begin je projectmanagement reis door je eigen account aan te maken. Het is snel en eenvoudig!
- 📋 **Bekijk een Lijst van Projecten**: Krijg een uitgebreid overzicht van al je lopende en voltooide projecten op een overzichtelijke plek.
- 🔍 **Filter de Lijst van Projecten**: Vind de projecten waar je naar op zoek bent in een mum van tijd met de eenvoudig te gebruiken statusgebaseerde filter.
- ➕ **Voeg een Project toe**: Heb je een nieuw project? Voeg het toe aan je lijst met slechts een paar klikken.
- ✏️ **Bewerk een Project**: Moet je wijzigingen aanbrengen in je projectdetails? De intuïtieve interface maakt bewerken een fluitje van een cent.
