    ...
    <div class="w-full max-w-screen-xl p-4 lg:p-8">
      <div class="flex justify-between items-center">
        ...
        <div class="lg:hidden flex gap-4 items-center">
          <span class="material-symbols-outlined cursor-pointer text-2xl transition duration-300"
            @click="themeStore.toggleTheme()">{{ themeStore.icon }}</span>
        ...
        <div class="hidden gap-10 items-center lg:flex">
          ...
          <span class="material-symbols-outlined cursor-pointer text-2xl navlink" @click="themeStore.toggleTheme()">{{
